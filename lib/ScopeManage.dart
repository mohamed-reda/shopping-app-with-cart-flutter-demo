...
var data = [
    ...
    },
    {
      ...
      "fav":true,
      "rating":4.5,
      "image":"https://cdn-image.travelandleisure.com/sites/default/files/styles/1600x1000/public/merrell_0.jpg?itok=wFRPiIPw"
    },
    {
    ...
    },
    {
      ...
      "fav":false,
      "rating":4.0,
      "image":"https://n.nordstrommedia.com/ImageGallery/store/product/Zoom/9/_100313809.jpg?h=365&w=240&dpr=2&quality=45&fit=fill&fm=jpg"
    },
    {
      "name":"ShoeGuru",
      "price":205.0,
...
class AppModel extends Model{
  ...
  InsertInCart(Data d) async{
    ...
    this._db.transaction((tx)async{
      try{
        var qry = 'INSERT INTO cart_list(shop_id,name, price, image,rating,fav) VALUES(${d.id},"${d.name}",${d.price}, "${d.image}",${d.rating},${d.fav ? 1 : 0})';
        var _res = await tx.execute(qry);
        this.FetchCartList();
      }catch(e){
        print(e);
  ...
  void addItem(Data dd){
    ...
    d.id = _data.length+1;
    d.name = "New";
    d.image = "https://rukminim1.flixcart.com/image/832/832/jao8uq80/shoe/3/r/q/sm323-9-sparx-white-original-imaezvxwmp6qz6tg.jpeg?q=70";
    d.price = 154.0;
    d.fav = false;
    d.rating = 4.0;
    _data.add(d);
